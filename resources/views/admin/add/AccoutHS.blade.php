...
<div class="container-fluid">
    ...
    <form  action="{{route('PaddAccoutHS')}}" method="POST" enctype="multipart/form-data" >
        {{ csrf_field() }}
        <div  style="padding-left: 35%;">
            ...
            <tr style="height: 45px">
                <th>Số điện thoại</th>
                <td style="padding-left: 5%;"><input type="text" placeholder="Số điện thoại" name="sdt"></td>
            </tr>
            <tr style="height: 45px">
                <th>Ngày Sinh</th>
            ...
            <tr>
                <section>
                    <option value="2017-2021" name="khoahoc">2017-2021</option>
                    <option value="2018-2022" name="khoahoc">2018-2022</option>
                    <option value="2019-2023" name="khoahoc">2019-2023</option>
                    <option value="2020-2024" name="khoahoc">2020-2024</option>
                <section>
            </tr>
